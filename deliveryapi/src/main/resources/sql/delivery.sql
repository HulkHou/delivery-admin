...
CREATE DATABASE IF NOT EXISTS delivery DEFAULT CHARSET utf8 COLLATE utf8_general_ci;
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES ('6', '世界', '10', '欢迎使用delivery管理系统', '2017-01-11 08:53:20', '1');
...
CREATE TABLE `sys_user` (
  ...
  `errorcount` int(11) NOT NULL DEFAULT '0' COMMENT '当天登录错误次数',
  `logintime` datetime DEFAULT NULL COMMENT '登录时间',
  `loginip` varchar(30) DEFAULT NULL COMMENT '用户登录IP地址',
  `createtime` datetime DEFAULT NULL COMMENT '创建时间',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'girl.gif', 'admin', 'ecfadcde9305f8891bcfe5a1e28c253e', '8pgby', '张三', '2017-05-05 00:00:00', '2', 'sn93@qq.com', '18200000000', '1', '27', '1', '0', null, null, null, null, null, null, null, null);
INSERT INTO `sys_user` VALUES ('44', null, 'test', '45abb7879f6a8268f1ef600e6038ac73', 'ssts3', 'test', '2017-05-01 00:00:00', '1', 'abc@123.com', '', '5', '26', '3',  '0', null, null, null, null, null, null, null, null);
INSERT INTO `sys_user` VALUES ('45', null, 'boss', '71887a5ad666a18f709e1d4e693d5a35', '1f7bf', '老板', '2017-12-04 00:00:00', '1', '', '', '1', '24', '1',  '0', null, null, null, null, null, null, null, null);
INSERT INTO `sys_user` VALUES ('46', null, 'manager', 'b53cac62e7175637d4beb3b16b2f7915', 'j3cs9', '经理', '2017-12-04 00:00:00', '1', '', '', '1', '24', '1',  '0', null, null, null, null, null, null, null, null);
