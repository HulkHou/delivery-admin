package com.hulk.deliveryapi.shiro;
...
public class MyShiroRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken auth)
        ...
        if (!JWTUtil.verify(token, phone, sysUser.getPassword())) {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        // 下面的可以使用缓存提升速度
        SysUser tUser = sysUserService.findBy("phone", phone);
...
//        authorizationInfo.addRole(tUser.getRoleid());
//        Set<String> permission = new HashSet<>(Arrays.asList(tUser.getPermission().split(",")));
